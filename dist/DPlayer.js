...
;// CONCATENATED MODULE: ./src/js/fullscreen-tauri.js
function fullscreen_tauri_classCallCheck(instance, Constructor) {
    if (!(instance instanceof Constructor)) {
        throw new TypeError('Cannot call a class as a function');
    }
}
function fullscreen_tauri_defineProperties(target, props) {
    for (var i = 0; i < props.length; i++) {
        var descriptor = props[i];
        descriptor.enumerable = descriptor.enumerable || false;
        descriptor.configurable = true;
...
function fullscreen_tauri_createClass(Constructor, protoProps, staticProps) {
    if (protoProps)
        fullscreen_tauri_defineProperties(Constructor.prototype, protoProps);
    if (staticProps)
        fullscreen_tauri_defineProperties(Constructor, staticProps);
    Object.defineProperty(Constructor, 'prototype', { writable: false });
    return Constructor;
}
...
var FullScreen = function () {
    function FullScreen(player) {
        var _this = this;
        fullscreen_tauri_classCallCheck(this, FullScreen);
        this.player = player;
    ...
    fullscreen_tauri_createClass(FullScreen, [
        {
            key: 'isFullScreen',
...
/* harmony default export */ const fullscreen_tauri = (FullScreen);
    ...
    info_panel_createClass(InfoPanel, [
        ...
        },
        {
            ...
            value: function update() {
                this.template.infoVersion.innerHTML = 'v'.concat("1.27.0", ' ').concat("844c375");
...
var DPlayer = function () {
    function DPlayer(options) {
        ...
        this.fullScreen = new fullscreen_tauri(this);
...
console.log('\n'.concat(' %c DPlayer v', "1.27.0", ' ').concat("844c375", ' %c https://dplayer.diygod.dev ', '\n', '\n'), 'color: #fadfa3; background: #030307; padding:5px 0;', 'background: #fadfa3; padding:5px 0;');
